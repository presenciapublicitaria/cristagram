...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>CriStagram :: @yield('titulo') </title>
    ...
    <body class="bg-gray-100">
        ...
        <footer class="my-10 text-center p-5 text-gray-500 font-bold uppercase">
            CriStagram - Todos los derechos reservados {{ now()->year }}
        </footer>
        @livewireScripts
    </body>
</html>
